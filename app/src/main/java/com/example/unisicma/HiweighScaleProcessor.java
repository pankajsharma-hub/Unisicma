...
public class HiweighScaleProcessor {
    ...
    public ScaleReading constructReading(byte[] payload) throws HiweighScaleException {
        ...
        if (payload[0] != 2 || payload[expectedPayloadSize-1] != 48) {
            throw new InvalidPayloadException();
        }
        ...
        */
        ...
        final String weightString = new String(Arrays.copyOfRange(payload, 6, 11+1));
        double weight;
